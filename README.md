...
<br />
<div align="center">
  <a href="https://github.com/mholzer78/dev.corbie.api">
    <img src="src/main/resources/static/images/corbie.svg" alt="Logo" width="80" height="80">
  </a>

<h3 align="center">api.corbie.dev</h3>

  <p align="center">
    developers best buddies API
  </p>
</div>
...
[https://api.corbie.dev](https://api.corbie.dev)
...
As I had a usecase for placeholder images that could be used directly in websites I started writing a backend-API which is the first and so far only service I provide. Initially supposed to be written in Python/Django, during development I switched to Java/Spring Boot.
...
Project Link: [https://api.corbie.dev](https://api.corbie.dev)
